  ...
  return (
    <div className="flex flex-row h-screen overfow-hidden ">
      ...
      <div className="flex flex-col items-center w-full overflow-auto">
        <h3 className="text-3xl md:text-4xl text-center mb-6 font-body font-bold text-gray-800"
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Enter your Company Name"/>
      </div> */}
      ...
      <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-last-name" type="text" placeholder="Doe"/>
          ...
          <div class="flex flex-wrap -mx-3 mb-2">
            ...
            {/* <label for="message" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Company Vision</label>
            <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your company's goal..."></textarea> */}
        ...
        <button
          ...
          className="font-body font-semibold tracking-wider disabled:bg-black w-1/3 max-w-md uppercase py-2 md:py-3 px-4 md:px-4 mt-4 rounded bg-black text-white text-lg md:text-xl transition duration-500 hover:bg-blue-300 hover:text-white cursor-pointer"
        >SignUp</button>
        <div>
