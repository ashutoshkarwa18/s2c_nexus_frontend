...
export default function CompanyProf() {
        ...
        <div class="container  bg-white rounded  shadow-lg  ">
          <div class="h-2/4 sm:h-64 overflow-hidden">
            <img
              ...
              src="https://images.unsplash.com/photo-1610374792793-f016b77ca51a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=774&q=80"
              alt="Photo"
            />
          </div>
          ...
          <div className='overflow-scroll scrollbar-hide h-60 mx-4 shadow-md border-b mb-5 rounded-md '>
          ...
          p-2.5 w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
              ...
              <div class="mb-3">
                <label for="rollnumber" class="block mb-2 text-md font-bold text-[#1F2937]">Email ID</label>
                <input name='identificationNumber' onChange={handleInputChange} value={compData.email} type="text" id="identificationNumber" class="shadow-sm focus:bg-[#C2D3E4] focus:outline-none 
          p-2.5 w-full   bg-gray-50 border border-gray-300 text-[#1F2937]  text-sm rounded-lg" />
              </div>
              <div class="mb-3">
  ...
  //         <div class="">
  //           <div class="px-7 mb-8">
  //             <h2 class="text-3xl font-bold text-[#0f172a] dark:text-gray-300">
  ...
  //               <button class="text-white hover:text-white p-1 sm:p-2 inline-flex items-center dark:text-gray-400 dark:hover:text-gray-300">
  //                 <svg
